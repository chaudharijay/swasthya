...
# Download stopwords during startup
...
def preprocess(user_symptoms):
    df_comb = pd.read_csv(r"dis_sym_dataset_comb.csv") # Disease combination
    df_norm = pd.read_csv(r"dis_sym_dataset_norm.csv") # Individual Disease
