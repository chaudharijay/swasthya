...
const Calendar = () => {
    ...
    if (mood.description !== '__' || sleep.description !== '__') {
        setIsModalOpen(true);
    } else {
	...
	const getMoodForDate = (date) => {
		...
		return moods[formattedDate] || { description: '__', tags: [], date: formattedDate };
	};

	const getSleepForDate = (date) => {
		const formattedDate = date.toLocaleDateString();
		return sleeps[formattedDate] || { description: '__', tags: [], date: formattedDate };
	};
