          ...
          <div className="relative  bg-gray-800 rounded-lg shadow ">
            ...
            <div className="p-4 md:p-5 pb-2 md:pb-2 space-y-4">
              {moodDescription == 'No mood recorded' ? (
                <p className="text-base leading-relaxed text-white-500 dark:text-gray-400">
                  No mood records available for this day.
                </p>
              ) : (
                  <div className="border-b text-white-500 border-gray-200 pb-2 mb-2">
            ...
            <div className="p-4 md:p-5 pt-2 md:pt-2 space-y-4">
              {sleepDescription == 'No sleep recorded' ? (
                <p className="text-base leading-relaxed text-white-500 dark:text-gray-400">
                  ...
                  <div className="text-white-900 border-gray-200 pb-2 mb-2">
